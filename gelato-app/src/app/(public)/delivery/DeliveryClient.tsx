...
import { CategoryFilter, ProductGridDelivery, ProductDetailModal } from '@/features/products'
import { CartBar, CartDrawer, useCartStore } from '@/features/cart'
...
export function DeliveryClient({ products, categories }: Props) {
  ...
  return (
    <>
      <div className="max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto px-4 py-6 space-y-6 pb-28">
        {/* Header */}
