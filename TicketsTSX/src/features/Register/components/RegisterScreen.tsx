...
const RegisterScreen = () => {
  ...
  const { handleState, handleChangeData, registerData } = useRegister();
          ...
          <div>
            <form className="grid gap-24 mt-16 text-base" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-4 gap-4">
                <select name="country" onChange={handleChangeData} className="border-b text-sm border-gray-300 py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:rounded-sm" defaultValue="">
                  <option value="" disabled>Pais</option>
                  <option value="Colombia">Col&nbsp;&nbsp;🇨🇴</option>
                </select>
                <input value={registerData.phone} name="phone" onChange={handleChangeData} type="tel" className="border-b text-sm border-gray-300 py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:rounded-sm col-span-3" placeholder="Telefono"></input>
              </div>
